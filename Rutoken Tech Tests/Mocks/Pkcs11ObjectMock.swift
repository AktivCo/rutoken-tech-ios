...
struct Pkcs11ObjectMock: Pkcs11ObjectProtocol {
    ...
    var bufferValues: [Pkcs11DataAttribute: Result<Data, Error>] = [:]
    var uLongValues: [Pkcs11CkUlongAttribute: Result<CK_ULONG, Error>] = [:]
    var boolValues: [Pkcs11BoolAttribute: Result<Bool, Error>] = [:]
    ...
    mutating func setValue(forAttr attrType: Pkcs11DataAttribute, value: Result<Data, Error>) {
        bufferValues[attrType] = value
    }

    mutating func setValue(forAttr attrType: Pkcs11CkUlongAttribute, value: Result<CK_ULONG, Error>) {
        uLongValues[attrType] = value
    }

    mutating func setValue(forAttr attrType: Pkcs11BoolAttribute, value: Result<Bool, Error>) {
